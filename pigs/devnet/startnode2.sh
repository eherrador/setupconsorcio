...
geth --datadir ./node2/ --syncmode 'full' --port 30312 --rpc --rpcaddr 'localhost' --rpcport 8502 --rpcapi 'personal,db,eth,net,web3,txpool,miner,admin,debug' --bootnodes 'enode://2b35ac907f8a9be8ec34180644bb906731df44525069c4c289ce8bdf0fe721e42ec922fc78d641b158814f0cd3abad76c766ba74dbf4a52df5959ceaf52da12c@127.0.0.1:30310' --networkid $1 --targetgaslimit 94000000 --gasprice '0' --unlock $2 --password ./password.txt --mine
